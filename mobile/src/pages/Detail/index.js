...
export default function Detail(){
    ...
    const message = `Hello ${incident.name}, I am touch because I would like to help in the case ${incident.title} with the value of ${Intl.NumberFormat('pt-BR', {style: 'currency', currency: 'BRL'}).format(incident.value)}.`;
